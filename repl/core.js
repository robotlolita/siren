...
// -- Dependencies -----------------------------------------------------
var __ref = require('../');
var toJsAst = __ref.toJsAst;
var generateJs = __ref.generateJs;
...
function evaluateCommand(runtime, context, rl, program, options) {
    return program === ':quit' ? process.exit(0) : run(runtime, context, rl, program, options);
}
function run(runtime, context, rl, program, options) {
    ...
    try {
        var result$2 = runProgram(runtime, context, js);
        maybeLog(runtime, options, result$2);
        loopEvaluation(runtime, context, rl, options);
    } catch (e) {
        showError(e, options);
        loopEvaluation(runtime, context, rl, options);
...
function repl(options) {
    ...
    loopEvaluation(runtime, context, readline.createInterface({
        input: process.stdin,
